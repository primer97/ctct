class currCargoset
{
    ...
    function steeltown()
    {
        ...
        Def.extCargo.append( { cargo =11, rate = 3.8, div = 5 }); // FOOD
        Def.extCargo.append( { cargo =17, rate = 4.2, div = 5 }); // PETR
    ...
    function inAHotCountry()
    {
        ...
        Def.extCargo.append( { cargo =23, rate = 4.2, div = 5 }); // PETR
        Def.extCargo.append( { cargo =11, rate = 3.8, div = 5 }); // FOOD
        Def.extCargo.append( { cargo = 5, rate = 4.2, div = 4 }); // GOOD
        Def.extCargo.append( { cargo = 5, rate = 4.2, div = 4 }); // DIAM // suppl
    ...
    function extrem()
    {
        ...
        Def.extCargo.append( { cargo =11, rate = 3.8, div = 5 }); // FOOD
        Def.extCargo.append( { cargo =22, rate = 3.8, div = 5 }); // PETR
        Def.extCargo.append( { cargo = 5, rate = 4.2, div = 5 }); // GOOD
